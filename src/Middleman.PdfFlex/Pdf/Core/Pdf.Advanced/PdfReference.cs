...
namespace Middleman.PdfFlex.Pdf.Advanced
{
    ...
    public sealed class PdfReference : PdfItem
    {
        ...
        PdfReference(PdfObject pdfObject, PdfObjectID objectID, SizeType position)
        {
            ...
            //    // Can be 0 or -1.
            //    //_ = typeof(int);
            //    //PdfFlexLogHost.DocumentProcessingLogger.LogError("Position is 0.");
            //}
        ...
        {
            // PdfFlex does not yet support PDF 1.5 object streams for writing.
        ...
        public PdfDocument Document
        {
            get
            {
                ...
                if (_document == null)
                {
                    PdfFlexLogHost.Logger.LogDebug("Document of object {_objectID} is null.", _objectID);
                }
#endif
                return _document!;
            }
