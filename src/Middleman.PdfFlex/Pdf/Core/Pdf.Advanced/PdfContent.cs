...
{
    /// <summary>
    /// Represents the content of a page. PdfFlex supports only one content stream per page.
    ...
    public sealed class PdfContent : PdfDictionary
    {
        ...
        {
            // If a content stream is touched by PdfFlex it is typically because graphical operations are
        ...
        /// <summary>
        /// When <c>true</c>, releases the content stream bytes after writing to reduce memory
        /// pressure. Used by the streaming renderer for large documents.
        /// </summary>
        internal bool ReleaseAfterWrite { get; set; }
        ...
        internal override void WriteObject(PdfWriter writer)
        {
            ...
            // Release content stream bytes after writing to reduce memory pressure.
            if (ReleaseAfterWrite && Stream != null!)
            {
                Stream.Value = Array.Empty<byte>();
            }
        }
