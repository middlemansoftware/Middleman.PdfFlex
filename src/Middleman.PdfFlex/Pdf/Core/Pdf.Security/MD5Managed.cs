...
// **************************************************************
// 
// We originally used this code for PdfFlex for Silverlight. The original code has a bug for
...
// However, the code of PdfFlex 1.5 still contains the bug. WTF.
//
// We reintroduced this code in PdfFlex 6.2 because today the .NET MD5 implementation issues
// a security warning and PdfFlex does not work for users that must use code that is FIPS
// compliant. We also need the code for PdfFlex running on Blazor and other platforms
...
namespace Middleman.PdfFlex.Pdf.Security
{
    ...
    class MD5Managed : HashAlgorithm
    {
        ...
        {
#if false  // Not used in PdfFlex. KEEP code for reference, but do not include it.
