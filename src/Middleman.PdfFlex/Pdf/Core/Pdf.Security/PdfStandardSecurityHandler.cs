...
using Middleman.PdfFlex.Pdf.Security.Encryption;
...
namespace Middleman.PdfFlex.Pdf.Security
{
    ...
    public sealed class PdfStandardSecurityHandler : PdfSecurityHandler
    {
        ...
        /// This was the default encryption in PdfFlex 1.5.
        /// </summary>
        ...
        internal uint GetCorrectedPermissionsValue()
        {
            ...
            // Top-most bit not correct, but can also be read with PdfFlex up to 6.1.0.
...
#else
            // Include this later as files can not be read with PdfFlex up to 6.1.0.
