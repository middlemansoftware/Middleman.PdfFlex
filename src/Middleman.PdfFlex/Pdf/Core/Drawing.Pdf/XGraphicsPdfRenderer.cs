    ...
    class XGraphicsPdfRenderer : IXGraphicsRenderer
    {
        ...
        internal void BeginPage()
        {
            if (_gfxState.Level == GraphicsStackLevelInitial)
            {
                ...
                // directed down and rotation clockwise. When I started with PdfFlex I flipped pages horizontally
                ...
                // generated with PdfFlex.
                // In PdfFlex 1.4 I implement a revised technique that does not need text mirroring anymore.
        ...
        /// <summary>
        /// PdfFlex uses the Td operator to set the text position. Td just sets the offset of the text matrix
