...
namespace Middleman.PdfFlex.Events
{
    ...
    /// </summary>
    public class PrepareTextEventArgs(PdfObject source, XFont font, string text) : PdfFlexEventArgs(source)
    {
        /// <summary>
    ...
    /// </summary>
    public class RenderTextEventArgs(PdfObject source, XFont font, CodePointGlyphIndexPair[] codePointGlyphIndexPair) : PdfFlexEventArgs(source)
    {
        /// <summary>
