...
namespace Middleman.PdfFlex.Pdf.AcroForms
{
    ...
    public abstract class PdfAcroField : PdfDictionary
    {
        ...
        public sealed class PdfAcroFieldCollection : PdfArray
        {
            ...
            /// PdfTextField or PdfCheckBox is returned if PdfFlex can guess the actual type of the dictionary.
            /// If the actual type cannot be guessed by PdfFlex the function returns an instance
            /// of PdfGenericField.
            /// </summary>
            ...
            /// If the actual cannot be guessed by PdfFlex the function returns an instance
            /// of PdfGenericField.
            /// </summary>
