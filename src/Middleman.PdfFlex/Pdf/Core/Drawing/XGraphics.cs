...
using Middleman.PdfFlex.Windows;
...
namespace Middleman.PdfFlex.Drawing
{
    ...
    public sealed class XGraphics : IDisposable
    {
        ...
        XGraphics(Graphics? gfx, XSize size, XGraphicsUnit pageUnit, XPageDirection pageDirection, RenderEvents? renderEvents = null)
        {
            ...
            if (gfx == null)
            {
                // Measure-only context - no PDF page target.
                try
                {
                    Lock.EnterGdiPlus();
...
#endif
#if GDI && WPF
            TargetContext = Middleman.PdfFlex.Internal.TargetContextHelper.TargetContext;
#endif
            _owner = page.Owner;
        ...
        XGraphics(XForm form, RenderEvents? renderEvents = null)
        {
            ...
            try
            {
                ...
                if (form.Owner != null)
                    _renderer = new Middleman.PdfFlex.Drawing.Pdf.XGraphicsPdfRenderer(form, this);
                _pageSize = form.Size;
            }
            finally { Lock.ExitGdiPlus(); }
            Initialize();
        ...
        public static XGraphics CreateMeasureContext(XSize size, XGraphicsUnit pageUnit, XPageDirection pageDirection, RenderEvents? renderEvents = null)
        {
            ...
            //PdfFlexLogHost.Logger.XGraphicsCreated("dummy page in dummy document used as measure context");
            ...
            PdfFlexLogHost.Logger.XGraphicsCreated("dummy GDI+ Graphics object used as measure context");
            ...
            PdfFlexLogHost.Logger.XGraphicsCreated("dummy WPF DrawingContext object used as measure context");
        ...
        public static XGraphics FromGraphics(Graphics graphics, XSize size, RenderEvents? renderEvents = null)
        {
            ...
            PdfFlexLogHost.Logger.XGraphicsCreated("GDI+ Graphics object");
        ...
        public static XGraphics FromDrawingContext(DrawingContext drawingContext, XSize size, XGraphicsUnit unit, RenderEvents? renderEvents = null)
        {
            ...
            PdfFlexLogHost.Logger.XGraphicsCreated("WPF DrawingContext object");
        ...
        public static XGraphics FromCanvas(Canvas canvas, XSize size, XGraphicsUnit unit, RenderEvents? renderEvents = null)
        {
            ...
            PdfFlexLogHost.Logger.XGraphicsCreated("WPF Canvas object");
        ...
        {
            PdfFlexLogHost.Logger.XGraphicsCreated
            return new XGraphics(drawingSession, size, unit, XPageDirection.Downwards);
        }
#endif

        /// <summary>
        /// Creates a new instance of the XGraphics class from a Middleman.PdfFlex.Pdf.PdfPage object.
        /// </summary>
        public static XGraphics FromPdfPage(PdfPage page)
        {
            ...
            PdfFlexLogHost.Logger.XGraphicsCreated("PDF page");
        ...
        /// <summary>
        /// Creates a new instance of the XGraphics class from a Middleman.PdfFlex.Drawing.XPdfForm object.
        /// </summary>
        public static XGraphics FromPdfForm(XPdfForm form)
        {
            ...
            PdfFlexLogHost.Logger.XGraphicsCreated("XPdfForm");

            return gfx;
        }

        /// <summary>
        /// Creates a new instance of the XGraphics class from a Middleman.PdfFlex.Drawing.XForm object.
        /// </summary>
        public static XGraphics FromForm(XForm form)
        {
            ...
            PdfFlexLogHost.Logger.XGraphicsCreated("XForm");
        ...
        /// <summary>
        /// Creates a new instance of the XGraphics class from a Middleman.PdfFlex.Drawing.XImage object.
        /// </summary>
        public static XGraphics? FromImage(XImage image, XGraphicsUnit unit, RenderEvents? renderEvents = null)
        {
            ...
            if (image is XBitmapImage bmImage)
            {
                ...
                PdfFlexLogHost.Logger.XGraphicsCreated("XImage");
                    ...
                    if (PageDirection == XPageDirection.Downwards)
                    {
                        switch (format.LineAlignment)
                        {
                            ...
                            case XLineAlignment.Center:
                                ...
                                if (test != y)
                                {
                                    PdfFlexLogHost.Logger.LogInformation($"DrawString XLineAlignment.Center: y={y} test={test}");
                                }
        ...
        public XSize MeasureString(string text, XFont font, XStringFormat stringFormat)
        {
            ...
            else
            {
                ...
                PdfFlexLogHost.FontManagementLogger.LogCritical(
            ...
            if (_drawGraphics)
            {
                ...
                if (TargetContext == XGraphicTargetContext.WPF)
                {
                    if (image._wpfImage != null!)
                    {
                        ...
                        //double x = destRect.X;
                        //double y = destRect.Y;
                        PdfFlexLogHost.Logger.LogWarning("DrawImage: srcRect is not used in WPF build.");
...
// #barcode => extension method
        ...
        public void WriteComment(string comment)
        {
            ...
            if (_drawGraphics)
            {
                PdfFlexLogHost.Logger.LogDebug("WriteComment has no effect in GDI or WPF build.");
            }
#endif
        ...
        //        /// This may be necessary to use PdfFlex safely in a Web application.
        //        /// </summary>
        ...
        /// Currently used for internal layout measurement only.
        /// </summary>
