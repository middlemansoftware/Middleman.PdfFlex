...
namespace Middleman.PdfFlex.Drawing
{
    ...
    public struct XUnit : IFormattable, IComparable<XUnit>, IComparable
    {
...
#else
            // According to the profiler this code makes PdfFlex remarkably slow.
        ...
        /// </summary>
        [Obsolete("In PdfFlex 6.1 implicit conversion from int is marked obsolete, because it led to misunderstandings and unexpected behavior. " +
        ...
        /// </summary>
        [Obsolete("In PdfFlex 6.1 implicit conversion from double is marked obsolete, because it led to misunderstandings and unexpected behavior. " +
                  "Provide the unit by XUnit.FromPoint() or use the new class XUnitPt instead.")]
        ...
        /// </summary>
        [Obsolete("In PdfFlex 6.1 implicit conversion to double is marked obsolete, because it led to misunderstandings and unexpected behavior. Use the XUnit.Point property instead.")]
