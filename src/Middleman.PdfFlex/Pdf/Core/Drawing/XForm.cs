...
namespace Middleman.PdfFlex.Drawing
{
    ...
    public class XForm : XImage, IContentStream
    {
        ...
        /// PdfFlex automatically calls this function when this form was used the first time
        ...
        {
            if (_formState == FormState.NotATemplate)
                throw new NotImplementedException("The current version of PdfFlex cannot draw on an imported page.");
        ...
        /// </summary>
        [Obsolete("Use either PixelWidth or PointWidth. Temporarily obsolete because of rearrangements for WPF. Currently same as PixelWidth, but will become PointWidth in future releases of PdfFlex.")]
        public override double Width => _viewBox.Width;

        /// <summary>
        /// Get the width of the page identified by the property PageNumber.
        /// </summary>
        [Obsolete("Use either PixelHeight or PointHeight. Temporarily obsolete because of rearrangements for WPF. Currently same as PixelHeight, but will become PointHeight in future releases of PdfFlex.")]
