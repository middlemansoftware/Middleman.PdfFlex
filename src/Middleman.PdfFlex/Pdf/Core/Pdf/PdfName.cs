...
namespace Middleman.PdfFlex.Pdf
{
    ...
    public sealed class PdfName : PdfItem
    {
        ...
        /// </summary>
        public static string AddSlash(string value) // TODO_OLD PdfFlex6: Naming. StL: WithSlash?
        {
            if (value.Length == 0)
                return "/";
        ...
        /// </summary>
        public static string RemoveSlash(string value) // TODO_OLD PdfFlex6: Naming. StL: WithoutSlash?
        {
            if (value.Length == 0 || value[0] != '/')
                return value;
