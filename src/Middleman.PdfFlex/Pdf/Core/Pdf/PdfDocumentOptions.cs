...
namespace Middleman.PdfFlex.Pdf
{
    ...
    public sealed class PdfDocumentOptions
    {
        ...
        /// With true, PdfFlex will try FlateDecode CCITT and will use the smallest one or a combination of both.
        /// With false, PdfFlex will always use FlateDecode only - files may be a few bytes larger, but file creation is faster.
        /// </summary>
