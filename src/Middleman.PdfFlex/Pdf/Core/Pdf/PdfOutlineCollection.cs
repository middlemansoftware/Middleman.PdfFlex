...
namespace Middleman.PdfFlex.Pdf
{
    ...
    public class PdfOutlineCollection : PdfObject, ICollection<PdfOutline>, IList<PdfOutline>
    {
        ...
        public void Add(PdfOutline outline)
        {
            ...
            // DestinationPage is optional. PdfFlex does not yet support outlines with action ("/A") instead of destination page ("/DEST")
        ...
        /// <summary>
        /// Gets the <see cref="Middleman.PdfFlex.Pdf.PdfOutline"/> at the specified index.
        /// </summary>
