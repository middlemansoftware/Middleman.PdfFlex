...
namespace Middleman.PdfFlex.Pdf
{
    ...
    public sealed class PdfDocumentInformation : PdfDictionary
    {
        ...
        /// <summary>
        /// Gets or sets the name of the application (for example, PdfFlex) that created the document.
        /// </summary>
        ...
        /// <summary>
        /// Gets the producer application (for example, PdfFlex).
        /// </summary>
        ...
        internal sealed class Keys : KeysBase
        {
            ...
            /// the name of the application (for example, Middleman PdfFlex) that created the
