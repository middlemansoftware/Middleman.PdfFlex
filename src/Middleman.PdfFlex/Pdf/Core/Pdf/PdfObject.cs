...
namespace Middleman.PdfFlex.Pdf
{
    ...
    public abstract class PdfObject : PdfItem
    {
        ...
        protected PdfObject(PdfDocument document)
        {
            ...
            // In PdfFlex Document is overridden in PdfPage and the code is checked to be save
        ...
        static void FixUpObject(PdfImportedObjectTable iot, PdfDocument owner, PdfObject value)
        {
            ...
            else
            {
                ...
                // Indirect integers, booleans, etc. are allowed, but PdfFlex do not create them.
        ...
        /// <summary>
        /// Ensure for future versions of PdfFlex not to forget code for a new kind of PdfItem.
        /// </summary>
        ...
        public PdfReference? Reference
        {
            ...
            // Setting the reference outside PdfFlex is not considered as a valid operation.
