...
namespace Middleman.PdfFlex.Pdf.Filters
{
    ...
    public class LzwDecode : Filter
    {
        ...
        /// <summary>
        /// Throws a NotImplementedException because the obsolete LZW encoding is not supported by PdfFlex.
        /// </summary>
        public override byte[] Encode(byte[] data)
        {
            throw new NotImplementedException("PdfFlex does not support LZW encoding.");
        }
