...
namespace Middleman.PdfFlex.Pdf.Annotations
{
    ...
    public sealed class PdfLinkAnnotation : PdfAnnotation
    {
        ...
        internal override void WriteObject(PdfWriter writer)
        {
            ...
            // After this issue was fixed in newer Reader versions older PdfFlex created documents show an ugly solid border.
            ...
            switch (_linkType)
            {
                ...
                case LinkType.Document:
                    // destIndex > Owner.PageCount can happen when rendering pages using PdfFlex directly.
