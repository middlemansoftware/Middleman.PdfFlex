...
{
    /// <summary>
    /// Defines the action to be taken by PdfFlex if a problem occurs during reading
    /// a PDF file.
    /// </summary>
    ...
    public class PdfReaderProblemDetails
    {
        ...
        /// <summary>
        /// Gets or sets a human-readable description of the action taken by PdfFlex for this problem.
        /// </summary>
