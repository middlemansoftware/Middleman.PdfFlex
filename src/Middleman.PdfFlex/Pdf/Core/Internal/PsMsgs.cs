...
namespace Middleman.PdfFlex.Internal
{
    ...
    static class PsMsgs
    {
        ...
        public static string UnexpectedTokenInPdfFile => $"Unexpected token in PDF file. The PDF file may be corrupt. If you think this is a bug in PdfFlex, please visit {UrlLiterals.LinkToCannotOpenPdfFile} for further information.";
