...
{
    /// <summary>
    /// Static locking functions to make PdfFlex thread save.
    ...
    static class Lock
    {
        public static void EnterGdiPlus()
        {
            ...
            if (IsFontFactoryLockedByCurrentThread)
            {
                ...
                PdfFlexLogHost.Logger.LogCritical("Entered GDI+ lock while FontFactory lock is also taken.");
            }
        }
        ...
        public static void EnterFontFactory()
        {
            ...
            {
                // This should not happen by design.
                PdfFlexLogHost.Logger.LogCritical("Entered FontFactory lock while GDI+ lock is also taken.");
            }
        }
