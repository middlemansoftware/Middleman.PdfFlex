...
{
    /// <summary>
    /// The one and only class that hold all PdfFlex global stuff.
    /// </summary>
    partial class Globals
    {
        ...
        /// <summary>
        /// The container of all global stuff in PdfFlex.
        /// </summary>
        ...
        public partial class FontStorage
        {
            ...
            public void CheckVersion(int version)
            {
                ...
                {
                    PdfFlexLogHost.Logger.LogCritical("Your XFont object is outdated because you have reset the font management.");
