...
using Middleman.PdfFlex.Pdf.Content;
    ...
    static class ParserDiagnostics  // #CLEANUP 
    {
        ...
        public static void HandleUnexpectedCharacter(char ch, string dump)
        {
            ...
            string message =
                ...
                Invariant($"If you think this is a bug in PdfFlex, please visit {UrlLiterals.LinkToCannotOpenPdfFile} for further information.\n") +
                dump;
