...
namespace Middleman.PdfFlex.Fonts
{
    ...
    public static class GlobalFontSettings
    {
        ...
        /// This static function must be called only once and before any font operation was executed by PdfFlex.
        ...
        static void SetFontResolver(IFontResolver value, ref IFontResolver? location)
        {
            ...
            {
                PdfFlexLogHost.Logger.LogWarning("Setting the same font resolver twice is ignored.");
                return;
            }
            ...
            {
                PdfFlexLogHost.Logger.LogWarning("Setting another instance of the same type of a font resolver is ignored.");
                return;
            }
        ...
        /// The font management is set to the same state as it has immediately after loading the PdfFlex library.
        /// </summary>
        /// <remarks>
        ...
        internal static void ResetAll(bool calledFromResetFontManagement = false)
        {
            if (calledFromResetFontManagement)
                PdfFlexLogHost.Logger.LogInformation("PdfFlex font management is about to be reset.");
...
#if CORE
        /// <summary>
        /// Gets or sets a value that defines what to do if the Core build of PdfFlex runs under Windows.
        /// If true, PdfFlex uses the build-in WindowsPlatformFontResolver to resolve some standards fonts like Arial or Times New Roman if
        /// the code runs under Windows. If false, which is default, you must provide your own custom font resolver.
        /// We recommend to use always a custom font resolver for a PdfFlex Core build.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value that defines what to do if the Core build of PdfFlex runs under WSL2.
        /// If true, PdfFlex uses the build-in WindowsPlatformFontResolver to resolve some standards fonts like Arial or Times New Roman if
...
#elif GDI || WPF
        /// <summary>
        /// This property has no effect under a GDI or WPF build of PdfFlex.
        /// </summary>
        public static bool UseWindowsFontsUnderWindows
        {
            get => true;
            ...
            {
                if (value == false)
                    PdfFlexLogHost.Logger.LogWarning("Setting UseWindowsFontsUnderWindows to false makes no sense and is ignored.");
            }
        }
        ...
        public static bool UseWindowsFontsUnderWsl2
        {
            ...
            {
                if (value)
                    PdfFlexLogHost.Logger.LogWarning("Setting UseWindowsFontsUnderWsl2 to true makes no sense under Windows and is ignored.");
            }
        }
#else
#error Should not come here
        ...
        /// <summary>
        /// Shortcut for PdfFlexCore.ResetFontManagement.
        /// </summary>
        public static void ResetFontManagement() => PdfFlexCore.ResetFontManagement();
...
namespace Middleman.PdfFlex.Internal
{
    partial class Globals
    {
        partial class FontStorage
        {
            ...
            /// <summary>
            /// If true PdfFlex uses some Windows fonts like Arial, Times New Roman from
