...
namespace Middleman.PdfFlex
{
    ...
    public static class Capabilities
    {
        static Capabilities()
        {
            // FooBarEnum3 reference removed (was placeholder/test code).
#if DEBUG_
        ...
        /// <summary>
        /// Resets the capabilities settings to the values they have immediately after loading the PdfFlex library.
        /// </summary>
        /// <remarks>
        ...
        {
            PdfFlexLogHost.Logger.LogInformation("All PdfFlex capability settings are about to be reset.");
        ...
        /// <summary>
        /// Access to information about the current PdfFlex build via fluent API.
        /// </summary>
        public static class Build
        {
            /// <summary>
            /// Gets the name of the PdfFlex build.
            ...
            /// <summary>
            /// Gets a value indicating whether this instance is PdfFlex Core build.
            /// </summary>
            ...
            /// <summary>
            /// Gets a value indicating whether this instance is PdfFlex GDI+ build.
            /// </summary>
            ...
            /// <summary>
            /// Gets a value indicating whether this instance is PdfFlex WPF build.
            /// </summary>
...
#endif
            /// <summary>
            /// Gets the .NET version number PdfFlex was built with.
            /// </summary>
        ...
        public static class IsAvailable
        {
            ...
            /// <summary>
            /// Gets a value indicating whether XPath.AddString is available in this build of PdfFlex.
        ...
        public static class Compatibility
        {
            ...
            /// If false, occurring exceptions will be rethrown and PdfFlex will only open correctly encrypted documents.
            /// If true, occurring exceptions will be caught and only logged for information purposes.
            /// This way PdfFlex will be able to load documents with unencrypted contents that should be encrypted due to the settings of the file.
            /// </summary>
