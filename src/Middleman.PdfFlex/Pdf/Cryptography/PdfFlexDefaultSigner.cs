...
namespace Middleman.PdfFlex.Pdf.Signatures
{
    ...
    /// </summary>
    public class PdfFlexDefaultSigner : IDigitalSigner
    {
        ...
        /// <summary>
        /// Creates a new instance of the PdfFlexDefaultSigner class.
        /// </summary>
        /// <param name="certificate"></param>
        /// <param name="digestType"></param>
        /// <param name="timeStampAuthorityUri"></param>
        public PdfFlexDefaultSigner(X509Certificate2 certificate, PdfMessageDigestType digestType, Uri? timeStampAuthorityUri = null)
        {
