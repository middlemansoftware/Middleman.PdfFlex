...
namespace PdfSharp.Pdf.IO
{
    ...
    class PdfWriter
    {
        ...
        public void WriteFileHeader(PdfDocument document)
        {
            ...
            if (Layout == PdfWriterLayout.Verbose)
            {
                WriteRaw($"% {PdfSharpProductVersionInformation.Title} {PdfSharpProductVersionInformation.Version} (verbose mode)\n");
        ...
        {
            WriteRaw($"% Created with {PdfSharpProductVersionInformation.Title} {PdfSharpProductVersionInformation.SemanticVersion} ({Capabilities.Build.BuildName}) under .NET {Capabilities.Build.Framework}\n");
            WriteRaw("startxref\n");
